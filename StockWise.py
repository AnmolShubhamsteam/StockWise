...
st.sidebar.image("Images/StockWiseLogo1.png", width=250,
...
# Stock Price Prediction Section Ends Here
    ...
    st.markdown('<p class="big-font">Welcome to StockWise, a comprehensive web application designed to provide users with powerful tools for stock performance comparison, real-time stock prices, and stock price prediction. Our mission is to empower investors, financial analysts, and anyone interested in the stock market with accurate and timely information, presented in an intuitive and user-friendly manner.</p>', unsafe_allow_html=True)
    st.markdown('<p class="big-font">Contact us at - <a href="https://anmol-portfolio-sigma.vercel.app/">https://anmol-portfolio-sigma.vercel.app/</a></p>', unsafe_allow_html=True)
    st.subheader('Developed By - Anmol Shubham , Amod Kumar, Ahzam Saba, Manaswi Kumar')
    st.subheader(' ')
